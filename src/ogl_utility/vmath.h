/***************************************************************************
 *   This file ( derived ) courtesy of the example code from :             *
 *                                                                         *
 ...
 *   Pub. Date: July 21, 2013                                              *
 *   Print ISBN-10: 0-321-90294-7                                          *
 *   Print ISBN-13: 978-0-321-90294-8                                      *
 *   Web ISBN-10: 0-13-336502-6                                            *
 *   Web ISBN-13: 978-0-13-336502-3                                        *
 *                                                                         *
...
namespace vmath {
    ...
    class TmatN : public matNM<T,N,N> {
        public:
            ...
            inline TmatN(const my_type& that) :
                        base(that) {
                }

            inline TmatN(float f) :
                        base(f) {
                }

            inline TmatN(const vecN<T,4>& v) :
                        base(v) {
                }
