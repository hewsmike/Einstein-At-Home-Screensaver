...
/**
 * \brief Adapter class which facilitates communications with the \b Einstein\@Home Gamma Pulsar application
 *
 * This adapter class can be used to query the \b Einstein\@Home Gamma Pulsar application
