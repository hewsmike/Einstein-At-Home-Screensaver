...
/**
 * \brief  Three dimensional vector data type.
 *
...
class Vector3D {
   public:
      ...
      /**
       * \brief Determine if a vector is equal to another
       *
       * \return A boolean indicating true it is equal, false otherwise
       */
      bool isEqual(const Vector3D& other) const;
   ...
   private:
      ...
      static const float NULL_LENGTH;
      static const float NULL_X;
      static const float NULL_Y;
      static const float NULL_Z;
	};
