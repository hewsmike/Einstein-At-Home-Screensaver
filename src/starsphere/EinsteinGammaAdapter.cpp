...
double EinsteinGammaAdapter::wuDispersionMeasure() const {
   return m_WUDispersionMeasure;
   }

double EinsteinGammaAdapter::wuTemplateOrbitalRadius() const {
   return m_WUTemplateOrbitalRadius;
   }

double EinsteinGammaAdapter::wuTemplateOrbitalPeriod() const {
   return m_WUTemplateOrbitalPeriod;
   }

double EinsteinGammaAdapter::wuTemplateOrbitalPhase() const {
   return m_WUTemplateOrbitalPhase;
   }

const vector<unsigned char>* EinsteinGammaAdapter::wuTemplatePowerSpectrum() const {
