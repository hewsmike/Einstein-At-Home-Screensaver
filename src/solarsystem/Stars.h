 ...
 *
 *      Assume they will be rendered identically, and implement with a
 * template that is parameterised by a Star derived type. Enacts the
...
template<class T> class Stars : public Renderable {
    ...
    private:
        ...
        /// Parameters use din OpenGL buffer object management.
        ...
        /// A helper structure to align position coordinate values.
        struct Position {
            vec_t x;
            vec_t y;
            vec_t z;
        ...
        /// The radius from the origin at which the Stars lie.
        vec_t star_rad;

        /// The rendered size of a star.
        GLfloat mag_size;

        /// The RGB color values for a star.
        GLclampf rgb_red;
        GLclampf rgb_green;
        GLclampf rgb_blue;
