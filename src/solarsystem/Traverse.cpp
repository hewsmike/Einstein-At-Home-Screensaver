...
Path Traverse::makePath() {
    ...
    // Plus the images
    ret_val.setStartImageResourceName(cam_states.at(start_lookout).getImageResourceName());
    ret_val.setFinishImageResourceName(cam_states.at(finish_lookout).getImageResourceName());
