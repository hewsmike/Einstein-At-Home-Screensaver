 ...
 *        Radio Pulsar analysis application.
 *
...
class EinsteinRadioAdapter {
    public:
         ...
         *
         *   You want to call this method periodically to refresh any volatile
        ...
        /**
         * \brief Retrieves the right ascension of the currently searched sky
         *        position.
         *
        ...
        /**
         * \brief Retrieves the declination of the currently searched sky
         *        position.
         *
         * \return The right ascension (in degrees).
         */
        ...
        /**
         * \brief Retrieves the dispersion measure of the currently searched
         *        sky position.
         *
        ...
        /**
         * \brief Retrieves the projected orbital radius of the currently
         *        active template.
         *
        ...
        /**
         * \brief Retrieves the initial orbital phase of the currently active
         *        template.
         *
        ...
        /**
         * \brief Retrieves the completion fraction of the currently active
         *        work unit.
         *
         * \return The completion fraction ( range 0.0 - 1.0 ).
         */
        double wuFractionDone() const;

        /**
         * \brief Retrieves the amount of CPU time consumed for the currently
         *        active work unit during the active session.
         *
         * \return The accumulated CPU time consumed during this work unit
         *         session (in seconds).
         */
        double wuCPUTime() const;

        /// The identifier of the Einstein\@Home Radio Pulsar science
        /// application's shared memory area.
        static const string SharedMemoryIdentifier;

    private:
       /**
        * \brief Parses science application specific information into local
        *        attributes.
        *
        ...
        *
        *   This method can sort of resembles the callback method used in
        * conjunction with SAX parsers. It's called to process single XML
        * nodes (in our case element nodes only) encountered during XML
        * document (tree) traversal.
        *
        * \param xmlReader : a pointer to the current xmlReader instance.
        *
        * \param converter : reference to an existing string stream for
        *                    value/type conversion.
        *
        * \see parseApplicationInformation()
        */
       void processXmlNode(const xmlTextReaderPtr xmlReader,
