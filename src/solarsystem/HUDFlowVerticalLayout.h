...
#ifndef HUD_FLOW_VERTICAL_LAYOUT_H_
#define HUD_FLOW_VERTICAL_LAYOUT_H_
...
/**
 * \brief The container type having a vertical flow layout.
 *
 * \author Mike Hewson\n
 */

class HUDFlowVerticalLayout : public HUDFlowLayout {
   public:
      /**
       * \brief Constructor
       */
      HUDFlowVerticalLayout(HUDContainer* enclosing);

      /**
       * \brief Destructor
       */
      virtual ~HUDFlowVerticalLayout();
...
#endif /* HUD_FLOW_VERTICAL_LAYOUT_H_ */
